...
<header class="bg-primary text-white text-center py-4">
  ...
  <p>From Primary School to Advanced Research ans Developments</p>
</header>

<section class="journey-section bg-light py-5">
  <div class="container">
    <h2 class="text-center mb-5">Education Timeline</h2>
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">

      <!-- Primary Education -->
      <div class="col">
        <div class="card h-100 edu-card p-3">
          <div class="card-body">
      ...
      <div class="col">
        <div class="card h-100 edu-card p-3">
          <div class="card-body">
            <div class="edu-icon mb-2">💻</div>
            <h5 class="card-title">Undergraduate Degree</h5>
            <p class="card-text">Bachelor’s degree in Computer Science or related field. Core programming, data structures, and software engineering.</p>
          </div>
        </div>
      </div>
